...
card_background = canvas.create_image(412, 275, image=card_front_img)
canvas.config(highlightthickness=0)
card_title = canvas.create_text(408, 170, text="", font=("Ariel", 40, "italic"))
card_word = canvas.create_text(412, 283, text="", font=("Ariel", 60, "bold"))
